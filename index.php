...
<body>
	...
	<ul class="out">
			...
			<div class="znoscreen">
				<h3>Іспити ЗНО</h3>
				<p>Тут ви можете здати ЗНО з потрібних вам предметів, які зазначені у вікні вибору ВНЗ, але й пройти всі ці екзамени буде корисно для кожного. Онлайн тестування не містить деяких завдань, максимальна оцінка з українсько мови і літератури - 180 балів(відсутній твір), з математики - 186 балів (відсутні завдання з повним пояснинням).</p>
				<div class="bookshelf">
