jQuery('document').ready(function(){
	...
	jQuery('.mesform').html("<h2>Вітаємо в квесті!</h2> <br \/> Який безлад! Напевно буде важео знайти тут щось. Ви маєте зібрати усі документи потрібні для вступу, натиснувши на них. А тепер добре запам'ятайте, що ви повинні мати: Атестат, Паспорт, Екзаменаційний листок ... Будьте уважні, не натискайте на непотрібні документи! Удачі!");
